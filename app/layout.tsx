...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'yoga classes fees Jaipur',
    'yoga class price Jaipur',
    'yoga for weight loss Jaipur',
    'yoga for beginners Jaipur',
    'morning yoga classes Jaipur',
    'evening yoga classes Jaipur',
    'affordable yoga classes Jaipur',
    'cheap yoga classes Jaipur',
    'yoga classes near Mahesh Nagar',
    'best yoga teacher in Jaipur',
    'yoga classes whatsapp number',
    'yoga camp for kids',
    'yoga camp for kids near me',
    'yoga teacher for home near me',
    'yoga teacher training',
    'yoga',
    'best yoga center near me',
    'yoga centre near me',
    'yoga near me',
    'yoga institute in jaipur',
    'yoga for teenagers',
    'aerial yoga jaipur',
    'activities to learn near me',
  ],
  openGraph: {
