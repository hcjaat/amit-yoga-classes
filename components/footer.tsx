...
function BrandIcon({ name }: BrandIconProps) {
  const brand = brandIcons[name];
  if (!brand) return null;
  return (
    <svg viewBox={brand.viewBox} fill="currentColor" className="w-5 h-5">
      <path d={brand.path} />
    </svg>
  );
}
...
const socialLinks = [
  {
    name: 'Instagram',
    brand: 'Instagram',
    href: 'https://www.instagram.com/amit.yoga.classes_jaipur/',
    bg: brandIcons.Instagram.color,
  },
  {
    name: 'Facebook',
    brand: 'Facebook',
    href: 'https://www.facebook.com/61559121976192/videos/',
    bg: brandIcons.Facebook.color,
  },
  {
    name: 'YouTube',
    brand: 'YouTube',
    href: 'https://www.youtube.com/@AMITSYOGACLASSES/shorts',
    bg: brandIcons.YouTube.color,
  },
  {
    name: 'WhatsApp',
    brand: 'WhatsApp',
    href: 'https://wa.me/919352600526',
    bg: brandIcons.WhatsApp.color,
  },
];
...
const services = [
  { label: 'Center Classes', href: '#services' },
  { label: 'Home Tuition', href: '#services' },
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1E3A2B] text-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <h3 className="font-semibold text-lg mb-5 text-white">Contact Info</h3>
          ...
          >
            <h3 className="font-semibold text-lg mb-5 text-white">Follow Us</h3>
            <div className="flex gap-3">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileHover={{ scale: 1.2, boxShadow: '0 0 25px rgba(255,255,255,0.4)' }}
                  whileTap={{ scale: 0.95 }}
                >
                  <BrandIcon name={social.brand} />
                </motion.a>
              ))}
            </div>
          </motion.div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-white/70 text-sm">
              © {new Date().getFullYear()}{" "}Amit&apos;s Yoga Classes
            </span>
          </div>
          <p className="text-xs text-white/50 flex items-center gap-1">
            Made with <Heart className="w-3 h-3 text-yoga-accent fill-current" /> by Hemant
          </p>
        </motion.div>
      </div>
    </footer>
